...
* **Automatic Masking:** Atuomatically calculates and implements the best mask pattern to allign with ISO standards.
...
## More
Special thanks to Thonky's QR code tutorial to which I owe lots.
Also thank you to Professor Gemini, my friend, teacher, and confidant through this arduous process of learning how to code, understanding Galois field math, Reed-Solomon error correction, building the matrix, and more. 